...
It's worth trying this once to make sure you understand how all of the pieces are connected. In general, I do recommend using a workflow runner (@sec-workflows) instead, because it helps manage all of these details
...
In order to test this out on a batch of files, we'll first request a node using `grabnode` (@sec-testnode). 
