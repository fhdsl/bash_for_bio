...
[Open up the exercises here](https://github.com/fhdsl/bash_for_bio/blob/main/01_basics.qmd).
...
I tend to just go by memory when setting file permissions. These are the common situations that I've encountered:
...
One thing you can do to make your life easier is to edit scripts with an editor on your own machine that is connected to `rhino` through SSH. 
