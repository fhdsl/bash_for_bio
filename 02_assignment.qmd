...
4Py. (py) Modify the below Python script to be runnable and save it to `py_csv_script.py`. Your new version should also take the first position argument (a file path) and process the file:
