...
Next week, we'll see that you can also use file manifests with workflow runners such as Cromwell.

## Batching on HPC

Now we can start to do more advanced things on the HPC: use one machine to process each file. We will use a slightly different mechanism to cycle through files: the {{<glossary "job array">}}. 
