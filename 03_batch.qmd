...
```bash
tladera2@rhino01:~$ ls -l slurm-26328834_*
```
...
What happened here? `sbatch` submitted our job array as 5 different subjobs to 5 different nodes under a single job id. Each node then output a 
