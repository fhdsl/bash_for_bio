---
title: "Week 2: Batch Processing and Submitting Jobs"
---
...
If you want to look at the jobs that a particular user is running, you can use the -u flag. Try squeue -u on one of the users in the queue, for example `tladera2`:
...
Next week we will talk about using Containers on the cluster using `Apptainer`.
